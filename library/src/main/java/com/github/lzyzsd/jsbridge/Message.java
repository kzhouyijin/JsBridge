...
public class Message {
    ...
    private String methodId; //methodId  1 onSuccess,1 onFailed
    ...
    private final static String METHOD_ID_STR = "methodId";
    public final static String METHOD_SUCCESS="success";
    public final static String METHOD_FAIL="fail";
    public final static String METHOD_COMPLETED="complete";
...
//            }
            ...
            jsonObject.put(METHOD_ID_STR, getMethodId());
	...
	public static Message toObject(String jsonStr) {
        ...
        try {
            ...
            m.setMethodId(jsonObject.has(METHOD_ID_STR) ? jsonObject.getString(METHOD_ID_STR):null);
            return m;
        } catch (JSONException e) {
            e.printStackTrace();
        }
